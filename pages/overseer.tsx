...
export default function BusinessPortal() {
  ...
  useEffect(() => {
    const ok = localStorage.getItem("overseer_portal_ok") === "1";
  ...
  const fetchClients = async (pinValue: string) => {
    ...
    try {
      ...
      setAuthed(true);
      localStorage.setItem("overseer_portal_ok", "1");
    } catch (e: any) {
      setErr(e?.message || "Login failed");
      setAuthed(false);
      localStorage.removeItem("overseer_portal_ok");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: 16 }}>
        <h1 style={{ fontSize: 22, fontWeight: 800, marginBottom: 12 }}>Overseer Portal</h1>
        ...
        {!authed ? (
          ...
          <>
            <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap", marginBottom: 12 }}>
              ...
              />
              <button
                onClick={() => fetchClients(pin || (localStorage.getItem("overseer_portal_pin") || ""))}
